    ...
    <>
      ...
      <div className='absolute rounded-sm top-0 left-0 bg-black md:bg-white right-0 bottom-0 flex justify-center items-center'>
        <div className='w-[90%] md:w-1/2 rounded-sm xl:w-1/4 h-fit  bg-slate-50 p-4 drop-shadow-xl'>
            <form id='birthdayforms' onSubmit={EventForm.handleSubmit(handleEventSubmit)} className='w-full md:w-[90%] mx-auto'>
              {type === "Birthday" ? <div>
              ...
              <section className='w-full flex space-x-2'>
                ...
                <button className='relative w-full p-2 bg-blue-600 text-white rounded-sm hover:bg-blue-500 active:bg-blue-700'>{type === "Birthday" ? 'Update Birthday' : type === "Event" && 'Update Event' }
